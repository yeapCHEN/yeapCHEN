...
void hua_wang(void)
{
    ...
    POINT_COLOR = YELLOW;
	LCD_DrawRectangle(0,9,250,210,POINT_COLOR);
	GUI_Line(0,110,250,110,POINT_COLOR);
	GUI_Line(125,9,125,210,POINT_COLOR);
...
void set_background(void)
{
	...
	LCD_DrawRectangle(259,9,260+58,211,GREEN);
	GUI_Show12ASCII(0,224,"www.prechin.com",POINT_COLOR,WHITE);
	GUI_Show12ASCII(204,224,"mv",POINT_COLOR,WHITE);	
	GUI_Show12ASCII(132,224,"vpp=",POINT_COLOR,WHITE);
	GUI_Show12ASCII(260,10,"us/div:",POINT_COLOR,WHITE);
	GUI_Show12ASCII(260,90,"mv/div:",POINT_COLOR,WHITE);
